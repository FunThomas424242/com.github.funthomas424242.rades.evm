 ...
 * <ul>
 *   <li>{@link com.github.funthomas424242.rades.evm.evm.impl.FeatureImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link com.github.funthomas424242.rades.evm.evm.impl.FeatureImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureImpl extends NamedElementImpl implements Feature
{
  ...
  {
    return EvmPackage.Literals.FEATURE;
  }
  ...
  public void setKind(FeatureKind newKind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EvmPackage.FEATURE__KIND, oldKind, kind));
  }
  ...
  public Type getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EvmPackage.FEATURE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Type newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EvmPackage.FEATURE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EvmPackage.FEATURE__KIND:
        return getKind();
      case EvmPackage.FEATURE__TYPE:
